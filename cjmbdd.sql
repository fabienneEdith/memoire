...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 12 nov. 2024 à 12:52
...
INSERT INTO `eleve` (`id_eleve`, `nom_eleve`, `prenoms_eleve`, `matricule_eleve`, `id_utilisateur`, `id_classe`, `classe_eleve`) VALUES
(26, 'KOFFI', 'TCHIAMBLAH EDITH FABIENNE', '14255489L', NULL, 36, '');
...
CREATE TABLE `note` (
  ...
  `type_note` varchar(250) NOT NULL,
...
(44, 'KOUASSI', 'ROMEO JULES', '14255496B', '0000-00-00', 'Femme', '', '15', '', '32', NULL),
...
--
ALTER TABLE `eleve`
  MODIFY `id_eleve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `professeur`
  MODIFY `id_professeur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
